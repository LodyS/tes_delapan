                ...
                <div id="result"></div>
                    <form id="uploadForm" method="POST" enctype="multipart/form-data">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <label for="file"> Kampret <span class="text-danger">*</span> </label>
                                <input type="file" name="kampret" id="kampret" multiple class="form-control">
                            </div>
        ...
        $(document).ready(function() {
            ...
            $("#uploadForm").validate({
                ...
                messages: {
                    ...
                    'kampret':{
                        required: "Please upload kampret",
                    }
                },
